...
onready var _collision_transformation = $CollisionShape2D.get_transform().get_scale()
...
func _change_size(w, h):
	...
	$CollisionShape2D.set_scale(Vector2(_collision_transformation.x*w, _collision_transformation.y*h))
